-- Repair: complexes_in_bounds must be DROPped before return type changes.
-- Run this if 20260603000001 failed with:
...
comment on function public.complexes_in_bounds is
  'Map viewport buildings with cached rent/score/signal columns.';
